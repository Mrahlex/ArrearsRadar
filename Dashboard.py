...
column1=['Tenant Age', 'Gender','Employment Status', 'Income Level','Socio-economic Background', 'Highest Education','Location', 'Property Type', 'Property Size',
...
def app(df, st):
    ...
    if "Bivariate" in selected_analysis:
        ...
        for numeric_column in df[column1].select_dtypes(include=['integer', 'float']):
            for categorical_column in df[column1].select_dtypes(include=['object']):
